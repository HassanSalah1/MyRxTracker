    ...
    <div class="container px-lg-5">
        <div class="row mt-4">
            <div class="col-lg-12 text-center my-auto pe-lg-5 text-center px-lg-5 mb-5">
                ...
                <h1 class="default-color lh-base text-center my-5 px-lg-5">Terms of Use</h1>
...
<div class="container px-lg-5 py-5">
    <section>
        ...
        <p>Throughout the site, the terms "we", "us" and "our" refer to Rxilient Medical (Hong Kong) Limited ("RXILIENT"). RXILIENT offers this website, including all information, tools and services available from this site ("Service") to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.<br>
    ...
    <section>
        <h2 class="h4 mt-4">1. Online Site</h2>
        ...
        A breach or violation of any of the Terms will result in an immediate termination of our Service.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">2. General Conditions</h2>
    ...
    <section>
        <h2 class="h4 mt-4">3. Accuracy, Completeness and Timeliness of Information</h2>
    ...
    <section>
        <h2 class="h4 mt-4">4. Medical Disclaimer</h2>
        <p>The content on this website is for informational purposes only and is not intended to be a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified healthcare provider with any questions you may have regarding a medical condition. Never disregard professional medical advice or delay in seeking it because of something you have read on this website.<br>
        Using this website does not create a doctor-patient relationship between you and RXILIENT. If you think you may have a medical emergency, call your doctor or emergency services immediately.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">5. Modifications to the Service and Prices</h2>
    ...
    <section>
        <h2 class="h4 mt-4">6. Products or Services (if applicable)</h2>
        ...
        We have made every effort to display as accurately as possible the colors and images of our products that appear at our site. We cannot guarantee that your computer monitor's display of any color will be accurate.<br>
    ...
    <section>
        <h2 class="h4 mt-4">7. Accuracy of Billing and Account Information</h2>
    ...
    <section>
        <h2 class="h4 mt-4">8. Optional Tools</h2>
    ...
    <section>
        <h2 class="h4 mt-4">10. User Comments, Feedback and Other Submissions</h2>
    ...
    <section>
        <h2 class="h4 mt-4">11. Personal Information</h2>
    ...
    <section>
        <h2 class="h4 mt-4">12. Errors, Inaccuracies and Omissions</h2>
    ...
    <section>
        <h2 class="h4 mt-4">13. Prohibited Uses</h2>
    ...
    <section>
        <h2 class="h4 mt-4">14. Disclaimer of Warranties; Limitation of Liability</h2>
        ...
        In no case shall RXILIENT, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers , licensors and/or any other authorised representative(s) be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Due to certain states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">15. Indemnification</h2>
        <p>You agree to indemnify, defend and hold harmless to RXILIENT and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns, employees and/or any other authorised representative(s), harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">16. Severability</h2>
        <p>In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">17. Termination</h2>
        ...
        These Terms of Service are effective unless and until terminated by either you or us. You may terminate these Terms of Service at any time by notifying us that you no longer wish to use our Service, or when you cease using our site.<br>
        If in our sole judgment you fail, or we suspect that you have failed, to comply with any term or provision of these Terms of Service, we also may terminate this agreement at any time without notice and you will remain liable for all amounts due up to and including the date of termination; and/or accordingly may deny you access to our Service (or any part thereof).</p>
    </section>

    <section>
        <h2 class="h4 mt-4">18. Entire Agreement</h2>
    ...
    <section>
        <h2 class="h4 mt-4">19. Governing Law</h2>
        <p>These Terms of Service and any supplementary agreements in relation to the Terms of Service which we provide to you shall be governed by and construed in accordance with the laws of Hong Kong without giving effect to the conflicts of laws provision thereof.<br>
        If there is any other translation version of this Terms of Service, the English version shall prevail.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">20. Changes to Terms of Service</h2>
        <p>You can review the most current version of the Terms of Service at any time at this page.<br>
        We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Your continuous use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.</p>
    </section>

    <section>
        <h2 class="h4 mt-4">21. Contact Information</h2>
        <p>Questions about the Terms of Service should be sent to us at <a href="mailto:RXM@rxilient.com">RXM@rxilient.com</a>.</p>
    </section>
</div>
